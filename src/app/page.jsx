    ...
    <div className="p-4 ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {filterProducts.map((product) => {
          const isAddedToCart = cartData.some((cartItem) => cartItem.id === product.id);
          return (
            <div
              key={product.id}
            ...
            >
              ...
              <button
                ...
                type="button"
                className={`focus:outline-none text-white font-medium rounded-[5px] text-sm px-5 py-2.5 mt-3 ${
                  isAddedToCart
